...
class LID(sb.Brain):
    ...
    def compute_forward(self, batch, stage):
        ...
        if self.hparams.freeze_emeddings:
            with torch.no_grad():
    ...
    def compute_objectives(self, inputs, batch, stage):
        ...
        loss_a = self.hparams.compute_cost(predictions, targets)
        loss_inter = compute_loss_inter(self.modules.classifier)
        loss = (1 - lambda_inter) * loss_a + lambda_inter * loss_inter
