#!/usr/bin/python3
"""Recipe for training language embeddings using the CommonVoice.
We employ an encoder followed by a speaker classifier.

To run this recipe, use the following command:
> python train_speaker_emb.py {hyperparameter_file}

Using your own hyperparameter file or one of the following:
    hparams/train_xvec_emb.yaml (for standard xvectors)
    hparams/train_ecapa_emb.yaml (for the ecapa+tdnn system)
